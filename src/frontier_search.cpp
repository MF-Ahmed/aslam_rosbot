...
#include "aslam_turtlebot/costmap_tools.h"
...
namespace frontier_exploration {
    ...
    std::vector<Frontier> FrontierSearch::searchFrom(const geometry_msgs::Point& position)
    {
        ...
        {
            ROS_ERROR("Robot out of costmap bounds, cannot search for frontiers .... please move the robot using 2D Nav Goal and launch again this node ");
            //return {};
        }
