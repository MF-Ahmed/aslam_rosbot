...
#include "aslam_rosbot/get_frontier_list.h"
#include "aslam_rosbot/get_best_path.h"
#include "aslam_rosbot/get_best_head.h"

#include "robot_localization/SetPose.h"
#include <message_filters/sync_policies/approximate_time.h>
#include <message_filters/sync_policies/exact_time.h>

class rosbot_fsm_node {
...
public:
    ...
    rosbot_fsm_node(ros::NodeHandle nh, ros::NodeHandle private_nh);
