...
ros1_simulation_cmd = "roslaunch aslam_rosbot office.launch  "
ros1_karto_cmd = "roslaunch aslam_rosbot graph_dopt.launch    "
d_opti_plot = "rosrun aslam_rosbot d_opti_plot.py"
map_saver = "rosrun map_server map_saver -f _rosbot_27thJune"
...
def main():
    ...
    launch_terminal(map_saver, "map_saver", ros1=True)
    print("Map Saved...")
    time.sleep(3) # give some time to save the map 
