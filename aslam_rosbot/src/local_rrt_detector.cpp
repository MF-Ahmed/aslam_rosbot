...
int main(int argc, char **argv){
  ...
  ros::param::param<std::string>(ns+"/map_topic", map_topic, "/map");   // global map subscription 
  ...
  // Main loop
  while (ros::ok()){
    // Sample free inside the map! at the locations specified by Xstartx and Xstarty;
