...
pub = rospy.Publisher("/mobile_base/commands/velocity", Twist, queue_size=10)  # Publisher object which will publish "Twist" type messages
                            				 # on the "/cmd_vel" Topic, "queue_size" is the size of the
                                                         # outgoing message queue used for asynchronous publishing

sub = rospy.Subscriber("/base_scan", LaserScan, callback)  # Subscriber object which will listen "LaserScan" type messages
