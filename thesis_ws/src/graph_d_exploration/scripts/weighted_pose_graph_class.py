...
class weighted_pose_graph:
    # Constructor
    def __init__(self, namespace, nodes=None, edges=None, criteria='d_opt'):
    ...
    def getGraphAsMarkerArray(self, global_frame: str = _namespace+"/map") -> MarkerArray:
        """
        ...
        # Add edges
        edge_marker = createMarker(_namespace, mtype="lines", frame=global_frame, ns="graph_ns", colors=[0, 255, 0],
                                   lifetime=15, alpha=1.0, scale=0.1)
