...
#include <rosbot_mpc/NonLinearMPCConfig.h>
#include <dynamic_reconfigure/server.h>
#include "tf/transform_listener.h"
#include "std_msgs/Int8.h"
#include "rosbot_fsm_node.h"
...
private:
    ...
    dynamic_reconfigure::Server<rosbot_mpc::NonLinearMPCConfig> controller_dyn_config_server;

    void ControllerDynConfigCallBack(rosbot_mpc::NonLinearMPCConfig &config, uint32_t level);
